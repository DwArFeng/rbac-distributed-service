...
@Component
public class PermissionFilterSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case PermissionFilterSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case PermissionFilterSupportMaintainService.LABEL_LIKE:
