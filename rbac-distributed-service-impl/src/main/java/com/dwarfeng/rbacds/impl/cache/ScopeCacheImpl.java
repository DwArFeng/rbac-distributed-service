...
public class ScopeCacheImpl implements ScopeCache {
    ...
    private final RedisBatchBaseCache<StringIdKey, Scope, FastJsonScope> batchBaseCache;

    public ScopeCacheImpl(RedisBatchBaseCache<StringIdKey, Scope, FastJsonScope> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Scope get(StringIdKey key) throws CacheException {
    ...
    public void push(Scope value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Scope> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<Scope> entities, long timeout) throws CacheException {
