...
public class UserLookupServiceImplTest {
    ...
    public void setUp() {
        ...
        roleA = new Role(new StringIdKey("role.a"), "角色 A", true, "测试用角色");
        roleB = new Role(new StringIdKey("role.b"), "角色 B", false, "测试用角色");
        roleC = new Role(new StringIdKey("role.c"), "角色 C", true, "测试用角色");
        pexp1 = new Pexp(
                new LongIdKey(1L), roleA.getKey(), "+id_regex@^.*\\.1$", "正则: 匹配所有以 1 结尾的权限",
                "正则: 匹配所有以 1 结尾的权限"
        );
        pexp2 = new Pexp(
                new LongIdKey(2L), roleA.getKey(), "!exact@permission.a.1",
                "精确: 去除 permission.a.1", "精确: 去除 permission.a.1"
        );
        pexp3 = new Pexp(new LongIdKey(3L), roleB.getKey(), "!id_regex@^.*$", "正则: 去除所有权限", "正则: 去除所有权限");
        pexp4 = new Pexp(new LongIdKey(4L), roleB.getKey(), "!id_regex@^.*$", "正则: 去除所有权限", "正则: 去除所有权限");
        pexp5 = new Pexp(
                new LongIdKey(5L), roleC.getKey(), "+id_regex@^.*\\.3$", "正则: 匹配所有以 3 结尾的权限",
                "正则: 匹配所有以 3 结尾的权限"
        );
        pexp6 = new Pexp(
                new LongIdKey(6L), roleC.getKey(), "!exact@permission.c.3", "精确: 去除 permission.c.3",
                "精确: 去除 permission.c.3"
        );
        permission1 = new Permission(new StringIdKey("permission.a.1"), null, "测试权限 a.1", "测试用权限", 12450);
        permission2 = new Permission(new StringIdKey("permission.a.2"), null, "测试权限 a.2", "测试用权限", 12450);
        permission3 = new Permission(new StringIdKey("permission.a.3"), null, "测试权限 a.3", "测试用权限", 12450);
        permission4 = new Permission(new StringIdKey("permission.b.1"), null, "测试权限 b.1", "测试用权限", 12450);
        permission5 = new Permission(new StringIdKey("permission.b.2"), null, "测试权限 b.2", "测试用权限", 12450);
        permission6 = new Permission(new StringIdKey("permission.b.3"), null, "测试权限 b.3", "测试用权限", 12450);
        permission7 = new Permission(new StringIdKey("permission.c.1"), null, "测试权限 c.1", "测试用权限", 12450);
        permission8 = new Permission(new StringIdKey("permission.c.2"), null, "测试权限 c.2", "测试用权限", 12450);
        permission9 = new Permission(new StringIdKey("permission.c.3"), null, "测试权限 c.3", "测试用权限", 12450);
    }
    ...
    public void test() throws Exception {
        try {
            ...
            List<StringIdKey> userKeys = userLookupService.lookupForPermission(permission1.getKey())
            ...
            userKeys = userLookupService.lookupForPermission(permission2.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertFalse(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission3.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            ...
            userKeys = userLookupService.lookupForPermission(permission4.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertTrue(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission5.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertFalse(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission6.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertTrue(userKeys.contains(zhangSan.getKey()));
            assertTrue(userKeys.contains(liSi.getKey()));
            assertTrue(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission7.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertTrue(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission8.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertFalse(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            userKeys = userLookupService.lookupForPermission(permission9.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertFalse(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
            ...
            // 重复一遍，分析命中缓存时的性能。
            userKeys = userLookupService.lookupForPermission(permission1.getKey())
                    .stream().map(User::getKey).collect(Collectors.toList());
            assertFalse(userKeys.contains(zhangSan.getKey()));
            assertFalse(userKeys.contains(liSi.getKey()));
            assertFalse(userKeys.contains(wangWu.getKey()));
