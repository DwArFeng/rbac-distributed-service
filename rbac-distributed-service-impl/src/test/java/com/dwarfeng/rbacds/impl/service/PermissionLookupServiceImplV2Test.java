...
public class PermissionLookupServiceImplV2Test {
    ...
    public void setUp() {
        ...
        pexp1 = new Pexp(
                new LongIdKey(1L), roleA.getKey(), "v2;+id_regex@^.*$|id_regex@^.*\\\\.1$", "正则: 匹配所有以 1 结尾的权限",
                "正则: 匹配所有以 1 结尾的权限"
        );
        pexp2 = new Pexp(
                new LongIdKey(2L), roleA.getKey(), "v2;!id_regex@^.*$|exact@permission.a.1", "精确: 去除 permission.a.1",
                "精确: 去除 permission.a.1"
        );
        pexp3 = new Pexp(
        ...
        pexp5 = new Pexp(
                new LongIdKey(5L), roleC.getKey(), "v2;+id_regex@^.*$|id_regex@^.*\\\\.3$", "正则: 匹配所有以 3 结尾的权限",
                "正则: 匹配所有以 3 结尾的权限"
        );
        pexp6 = new Pexp(
                new LongIdKey(6L), roleC.getKey(), "v2;!id_regex@^.*$|exact@permission.c.3", "精确: 去除 permission.c.3",
