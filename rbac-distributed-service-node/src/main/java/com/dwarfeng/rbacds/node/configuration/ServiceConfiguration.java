...
public class ServiceConfiguration {
    ...
    @Autowired
    private com.dwarfeng.rbacds.node.configuration.DaoConfiguration daoConfiguration;
    @Autowired
    private com.dwarfeng.rbacds.node.configuration.CacheConfiguration cacheConfiguration;
    @Autowired
    private SnowFlakeLongIdKeyFetcher keyFetcher;
    @Autowired
    private com.dwarfeng.rbacds.node.configuration.ServiceExceptionMapperConfiguration serviceExceptionMapperConfiguration;
