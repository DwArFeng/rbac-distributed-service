 ...
 * @since 2.0.0
 */
public class WebInputPermissionCreateInfo implements Bean {

    private static final long serialVersionUID = -23379306202034875L;

    public static PermissionCreateInfo toStackBean(WebInputPermissionCreateInfo webInput) {
